...
/*******************************************************************
* Program Name: Changing Direction Anytime
*
...
*   screen once reaching them while allowing the user to change the
*   direction of the bitmap at anytime with the arrow keys.
*
* PseudoCode:
* Create window
...
*   IF the escape key was pressed close shop
*   IF the left arrow was pressed then move to the left
*   IF the right arrow was pressed then move to the right
*   IF the up arrow was pressed then move to the up
*   IF the down arrow was pressed then move to the down
...
int main(int argc, char* args[])
{
    ...
    "Changing Directions Anytime", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 800, 600, SDL_WINDOW_SHOWN);
    ...
    while(ProgramIsRunning())
    {
        ...
        {
            xDir = -1;
            MoveBitMap(xPos, yPos, bitMapWidth, bitMapHeight, xDir, yDir);
        }
